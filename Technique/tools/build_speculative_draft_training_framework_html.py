...
DEFAULT_SOURCE = TECHNIQUE_DIR / "md/speculative_draft_training_framework_comparison_report_20260825.md"
DEFAULT_OUTPUT_DIR = TECHNIQUE_DIR / "html/speculative-draft-training-framework-comparison-report-260825"
...
def render_html(title: str, article: str, toc_html: str) -> str:
    description = "Draft 模型训练框架调研：Speculators、SpecForge、TorchSpec 与 NeMo AutoModel 对比"
