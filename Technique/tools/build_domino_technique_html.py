...
DEFAULT_SOURCE = TECHNIQUE_DIR / "md/domino_technique_analysis_report_20260826.md"
DEFAULT_OUTPUT_DIR = TECHNIQUE_DIR / "html/domino-technique-analysis-report-260826"
...
def render_html(title: str, article: str, toc_html: str) -> str:
    description = "Domino 技术分析：自回归 Drafting、因果建模解耦、训练目标与推理部署"
